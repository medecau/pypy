...
def utf8_encode_wrapper(space, utf8, w_obj, errors):
    state = space.fromcache(CodecState)
    return unicodehelper.utf8_encode_utf_8(space, utf8, w_obj, errors,
...
def utf_8_encode(space, w_obj, errors="strict"):
    ...
    if errors is None:
        errors = 'strict'
    result = utf8_encode_wrapper(space, utf8, w_obj, errors)
    if errors == 'strict':
